      ...
      {NAV_ITEMS.map((item) => {
        ...
        if (item.isMain) {
          return (
            ...
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary-600 shadow-lg shadow-primary-200 ring-4 ring-background transition-transform hover:scale-105 active:scale-95">
                {item.icon}
              </div>
        ...
        return (
          ...
          >
            <div
              className={`p-2 rounded-full transition-colors ${isActive ? "bg-primary-50 dark:bg-primary-900/20" : ""}`}
            >
              {item.icon}
            </div>
